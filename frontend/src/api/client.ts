 ...
 * API Client
 *
 * All /api/* requests are proxied to the Render backend via vercel.json rewrites.
 * No base URL configuration needed — relative paths work in both dev and production.
 */
